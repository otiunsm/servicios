/*
 ...
 Source Schema         : resgistro_oti

 Target Server Type    : MySQL
 Target Server Version : 100432
 File Encoding         : 65001

 Date: 17/09/2024 00:06:43
*/
...
CREATE TABLE `act_registro`  (
  ...
  CONSTRAINT `act_registro_ibfk_1` FOREIGN KEY (`idcategoria_actividad`) REFERENCES `act_categoria_actividad` (`idcategoria_actividad`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ...
  CONSTRAINT `act_registro_ibfk_3` FOREIGN KEY (`id_estado`) REFERENCES `act_estado` (`id_estado`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `act_registro_ibfk_4` FOREIGN KEY (`idmedio_solicitud`) REFERENCES `act_medio_solicitud` (`idmedio_solicitud`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `act_registro_ibfk_5` FOREIGN KEY (`id_periodo`) REFERENCES `act_periodo` (`id_periodo`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
-- ----------------------------
INSERT INTO `automatizar` VALUES (1, 'Activación de consultas RENIEC', '2024-09-09', 1);
...
INSERT INTO `modulo` VALUES (21, 'Registro Actividad', '/', NULL, NULL, 1);
INSERT INTO `modulo` VALUES (22, 'registrar', '/act_registro/registro', 21, NULL, 1);
...
INSERT INTO `permiso` VALUES (433, 1, 21, 1);
INSERT INTO `permiso` VALUES (434, 1, 22, 1);
INSERT INTO `permiso` VALUES (435, 1, 2, 1);
INSERT INTO `permiso` VALUES (436, 1, 12, 1);
INSERT INTO `permiso` VALUES (437, 1, 11, 1);
INSERT INTO `permiso` VALUES (438, 1, 10, 1);
INSERT INTO `permiso` VALUES (439, 1, 9, 1);
INSERT INTO `permiso` VALUES (440, 1, 8, 1);
INSERT INTO `permiso` VALUES (441, 1, 5, 1);
INSERT INTO `permiso` VALUES (442, 1, 1, 1);
INSERT INTO `permiso` VALUES (443, 1, 18, 1);
INSERT INTO `permiso` VALUES (444, 1, 15, 1);
INSERT INTO `permiso` VALUES (445, 1, 4, 1);
INSERT INTO `permiso` VALUES (446, 1, 3, 1);
...
CREATE TABLE `usuario`  (
  ...
  CONSTRAINT `usuario_ibfk_2` FOREIGN KEY (`idarea`) REFERENCES `act_area` (`idarea`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE = InnoDB AUTO_INCREMENT = 1085 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = DYNAMIC;
...
INSERT INTO `usuario` VALUES (11, 'André Alonso', 'Rengifo del Aguila', '75244255', '$2a$07$asxx54ahjppf45sd87a5au9tt8kCgXuNSZJTnXaNlHbH8hUXyTZ4u', '1', '75244255', '042948809591', 1, 'a@gmail.com', '', 1, '2022-04-07', '2024-09-16 16:03:56', NULL, '2024-07-11 08:42:58', NULL);
...
INSERT INTO `usuario` VALUES (1084, 'Juan', 'Chuquipoma Fermin', '76381177', '$2a$07$asxx54ahjppf45sd87a5auLN8wfOBv6kolRtquoWQ.PsRKtwk14Xu', '1', '76381177', '917563898', 1, 'jan98chu@gmail.com', 'Jr. orellana 836', 1, '2024-12-16', '2024-09-16 16:37:18', '2024-09-16 16:05:10', '2024-09-16 16:08:29', NULL);
