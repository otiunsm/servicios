            ...
            <div class="card card-custom">
                <div class="card-header flex-wrap py-5">
                    ...
                    <div class="card-toolbar">
                        <button type="button" class="btn btn-primary btn-sm mr-4" data-toggle="modal" data-target="#formClasificador">
                        ...
                        <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#formImportar">
                            <i class="fas fa-upload mr-1"></i> Importar Clasificadores
                        </button>
                    </div>
                </div>
...
<div class="modal fade" id="formImportar" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content" id="kt_login2">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Importar Clasificadores</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <i aria-hidden="true" class="ki ki-close"></i>
                </button>
            </div>
            <form method="POST" action="<?= base_url('SegClasificadores/importarExcel') ?>" enctype="multipart/form-data">
                <div class="modal-body">
                    <div class="form-group">
