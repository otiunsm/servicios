    ...
    <body>
        ...
        <div class="panels">
            <div class="panels__container">
                <span class="panel">
                    <div class="panel__content" style="background-image: url(https://i.ibb.co/JsGCLTm/Local-administrativo-Local-Central.jpg);">
                        <center>
                           <!-- <div class="clock" style="z-index:-1; width:auto!important; display: inline flow-root list-item;"></div> -->
                            <h3 class="panel__title">Lo sentimos<br> la plataforma se encuentra en mantenimiento</h3>
                        </center>
                    </div>
                </span>
                <!-- <a href="https://unsm.edu.pe" id="portal" class="panel">
        ...
        <!--<div class="footer-distributed">-->
                        <div class="footer-left"><p class="copy" style="font-family:Verdana">Tarapoto, Perú - &copy; Copyright 2022 - Todos los derechos reservados</p></div>
                <!--</div>-->
    </body>
    ...
    <script type="text/javascript">
      ...
      var date = new Date("21 Mar 2022 13:30:00");
      var now = new Date();
