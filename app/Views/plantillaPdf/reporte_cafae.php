...
<head>
  ...
  <title>BOLETA DE PAGO - CAFAE <?= $Datos['coddocumento']?></title>
    ...
    <table class="encabezado">
      <thead>
        <tr>
          ...
          <th><h3>BOLETA DE PAGO - CAFAE <?= $Datos['coddocumento']?></h3></th>
          <th>
              <p>00000</p>
    ...
    <table class="encabezado-info">
      ...
      <thead>
        <tr>
          <td>
            ...
            <p><strong>Régimen Pensionario:</strong> <?= $Datos['desregimenlaboral']?> </p>
          ...
          <td>
            ...
            <p><strong>Condición:</strong> <?= $Datos['destiposervidor'].' '.$Datos['descondicion'] ?></p>
            <p><strong>Cargo:</strong> <?= $Datos['descargo']?></p>
      ...
      <tfoot>
        <tr>
          ...
          <th style="border-top: 2px solid black;"><?= $Datos['neto'] ?></th>
        </tr>
      </tfoot>
    </table>
      ...
      <tfoot>
        <tr>
          ...
          <th style="border-top: 2px solid black;border-bottom: 2px solid black"><?= $Datos['neto'] ?></th>
        </tr>
        <tr>
          <?php
              $formatterES = new NumberFormatter("es-ES", NumberFormatter::SPELLOUT);
              $entero = intval(floor($Datos['neto']));
              $decimal = explode('.', $Datos['neto']);
